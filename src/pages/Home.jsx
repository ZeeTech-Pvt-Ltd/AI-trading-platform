...
export default function Home() {
  ...
  useMeta(
    isFirstPage
      ? { title: null, path: '' }
      : {
          title: `More AI Trading Platform Reviews - Page ${page}`,
          description:
            'More AI trading platform reviews from the archive - what each platform claims, what we verified, and our verdict.',
          path: `page/${page}`,
        },
  )
            ...
            <div className="container">
              <div>
                ...
                <p className="hero__deck">
                  ...
                  few publish a licence number. This site reviews the platforms marketed to
                  Australians one at a time - we read every page they publish, search their
                  company on ASIC&rsquo;s Professional Registers, check the age and ownership
                  of their domain, and look for any independent trace of them existing. Then
                  we publish a verdict and the evidence behind it.
                </p>
              ...
              <aside className="hero__side" aria-label="Top rated">
                ...
                <Link to="/#reviews" className="hero__side-all">
                  View all reviews
