...
export default function PrivacyPolicy() {
  return (
    <LegalPage title="Privacy Policy" kicker="Legal" updated="September 8, 2026">
      <p>
        AI Trading Platform Reviews (“we”, “the desk”) operates the website at
        ai-trading-platform.com. This policy explains what information we collect when you
      ...
      <p>
        ...
        request deletion by writing to contact@ai-trading-platform.com. We respond within a
        reasonable time.
      </p>
