...
const overflow =
  REVIEWS.length > SHOWN
    ? `<text x="600" y="576" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-size="20" font-style="italic" fill="#3d382d">…and ${REVIEWS.length - SHOWN} more platforms reviewed at ai-trading-platform.com</text>`
    : ''
