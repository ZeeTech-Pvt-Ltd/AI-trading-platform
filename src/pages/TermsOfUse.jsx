...
export default function TermsOfUse() {
  return (
    <LegalPage title="Terms of Use" kicker="Legal" updated="September 8, 2026">
      <p>
        By accessing ai-trading-platform.com (“the site”), you agree to these terms. If you
      ...
      <p>
        The site’s text, layout and design are the property of AI Trading Platform Reviews. You may
      ...
      <p>
        The site is provided “as is”. To the maximum extent permitted by law, The Trading
        Ledger is not liable for any loss arising from your use of the site or from
