...
export default function About() {
  useMeta({
    ...
    description:
      'Who writes AI Trading Platform Reviews, how a platform gets scored, and the rules the desk works by.',
    path: 'about',
  })
      ...
      <div className="container">
        <div className="page-head">
          ...
          <p className="page-head__deck">
            AI Trading Platform Reviews exists because AI trading platforms publish a lot of words
