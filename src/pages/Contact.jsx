          ...
          <div>
            ...
            <div className="contact-info__item">
              ...
              <div>
                ...
                <p className="contact-info__value">{SITE.city}, Australia</p>
              </div>
            </div>
            <div className="contact-info__item">
              <span className="contact-info__icon">✎</span>
              <div>
                ...
                <p className="contact-info__value">
                  The desk covers AI trading and investing platforms aimed at Australian
                  users. Tell us the domain and why it matters.
                </p>
              </div>
            </div>
          </div>
